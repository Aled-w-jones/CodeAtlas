<script>
	...
	import { isDarkMode, toggleTheme, initializeTheme } from '../stores/theme.js';
...
<button
	...
	class="fixed top-4 right-4 z-50 p-3 rounded-full bg-vsc-bg-medium hover:bg-vsc-bg-light border border-vsc-border-light transition-all duration-300 shadow-lg hover:shadow-xl group"
...
>
	...
	<!-- Tooltip -->
	<div class="absolute right-full mr-3 top-1/2 -translate-y-1/2 px-2 py-1 bg-vsc-bg-light text-vsc-text-primary text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
